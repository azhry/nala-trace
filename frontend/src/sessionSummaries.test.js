  ...
  sessions: [
    {
      ...
      skill_invocation_count: 1,
        ...
        token_usage: { input_tokens: 12, total_tokens: 12, cost_usd: 0.0001 },
    },
    {
...
describe('session summary adapter', () => {
  it('uses the explicit API title as the primary row label', () => {
    ...
    expect(summary).toMatchObject({
      ...
      tokenUsage: { inputTokens: 12, cachedInputTokens: 0, outputTokens: 0, reasoningTokens: 0, totalTokens: 12, costUsd: 0.0001 },
      status: 'captured',
    })
